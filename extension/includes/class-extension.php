...
class Extension {
	...
	private function define_admin_hooks() {
		...
		add_action('add_meta_boxes', array($plugin_admin,'create_product_metabox'));
		add_action('save_post',array($plugin_admin, 'save_metabox_data'));
		add_theme_support('post-thumbnails');

		$this->loader->add_action( 'wp_ajax_tags_autofill_function', $plugin_admin , 'tags_autofill_function' );
    	$this->loader->add_action( 'wp_ajax_nopriv_tags_autofill_function', $plugin_admin , 'tags_autofill_function' );
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action('woocommerce_single_product_summary',$plugin_public, 'rendering_data',15);
